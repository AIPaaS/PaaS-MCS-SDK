...
public class CacheClientTest {
    ...
    public void testHgetByteArrayByteArray() {
        ...
        map.put("one", "123456");
        map.put("two", "123");
        client.hmset("dxf888", map);
        assertTrue("123456".equals(client.hmget("dxf888", "one").get(0)));
        client.del("dxf888");
    }
    ...
    public void testHmgetByteArrayByteArrayArray() {
        ...
        map.put("one".getBytes(), "123456".getBytes());
        map.put("two".getBytes(), "123".getBytes());
        client.hmset("dxf999".getBytes(), map);
        assertTrue("123456".equals(new String(client.hmget("dxf999".getBytes(), "one".getBytes()).get(0))));
        client.del("dxf999");
    }
    ...
    public void testHexistsByteArrayByteArray() {
        ...
        map.put("one".getBytes(), "123456".getBytes());
        map.put("two".getBytes(), "123".getBytes());
        client.hmset("dxf223344".getBytes(), map);
        assertTrue(client.hexists("dxf223344".getBytes(), "two".getBytes()));
        client.del("dxf223344");
    }
    ...
    public void testHgetAllByteArray() {
        ...
        map.put("one".getBytes(), "123456".getBytes());
        map.put("two".getBytes(), "123".getBytes());
        client.hmset("dxf444555".getBytes(), map);
        map = client.hgetAll("dxf444555".getBytes());
        assertTrue(2 == map.size());
        client.del("dxf444555");
    }
    ...
    public void testSaddByteArrayByteArrayArray() {
        ...
        client.sadd("dxf777999888".getBytes(), members1, members2);
        assertTrue(2 == client.smembers("dxf777999888".getBytes()).size());
        client.del("dxf777999888");
    }
    ...
    @Test
    public void testBenchInsert() {
        long start = System.currentTimeMillis();
        int hash;
        for (long i = 13500001000L; i < 13500009000L; i++) {
            client.set("" + i, "" + i);
            hash = Math.abs(("" + i).hashCode());
            client.setBit("1350000", hash, "1");
    ...
    @Test
    public void testBenchBit() {
        long start = System.currentTimeMillis();
        int hash;
        for (long i = 13500001000L; i < 13500009000L; i++) {
            hash = Math.abs(("" + i).hashCode());
            client.getBit("1350000", hash);
            System.out.println(i);
        }
        System.out.println(System.currentTimeMillis() - start);
    }
